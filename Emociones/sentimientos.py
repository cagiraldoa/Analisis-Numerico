...
def get_files(emotion):
    ...
    prediction=['dataset\\2.jpg'] #aqui se añade la imagen que quieres procesar
...
frame=cv2.imread('dataset\\2.jpg') #aqui se añade la imagen que quieres procesar pero aqui solo se carga para el resultado final
